"""
Django settings for lab63Project project.
...
SECRET_KEY = 'django-insecure-vebir0jr4%ah@3uw=h4xb-!e_61#e@f#iq+t+g$+yg-l+!vdd+'
...
ROOT_URLCONF = 'lab63Project.urls'
...
WSGI_APPLICATION = 'lab63Project.wsgi.application'
